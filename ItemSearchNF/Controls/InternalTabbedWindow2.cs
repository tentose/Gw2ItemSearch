...
{
    /// <summary>
    /// The InternalTabbedWindow2 is a control meant to replicate the standard Guild Wars 2 windows with tabs.
    /// </summary>
    public class InternalTabbedWindow2 : InternalWindowBase2, ITabOwner
    {
        ...
        /// <summary>
        /// Fires when a <see cref="InternalTabbedWindow2"/> Tab changes.
        /// </summary>
        ...
        public InternalTabbedWindow2(Texture2D background, Rectangle windowRegion, Thickness contentMargin)
        {
            this.Tabs = new TabCollection(this);
            this.ShowSideBar = true;

            this.ConstructWindow(background, windowRegion, contentMargin);
        }
