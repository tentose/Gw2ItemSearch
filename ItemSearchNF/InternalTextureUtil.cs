...
{
    public static class InternalTextureUtil
    {

        private static readonly Logger Logger = Logger.GetLogger(typeof(InternalTextureUtil));
        ...
        {
            var texture = FromStreamPremultiplied(GameService.Graphics.GraphicsDevice, stream);
